...
public class ViewMeasurementComponentsRecord extends TableRecordImpl<ViewMeasurementComponentsRecord> implements Record10<Integer[], Integer, Integer, Integer, String, Integer, String, BigDecimal, ViewMeasurementComponentsMeasurementType, Timestamp> {

    private static final long serialVersionUID = -872177355;
     ...
     */
    @Override
    public Row10<Integer[], Integer, Integer, Integer, String, Integer, String, BigDecimal, ViewMeasurementComponentsMeasurementType, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer[], Integer, Integer, Integer, String, Integer, String, BigDecimal, ViewMeasurementComponentsMeasurementType, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ViewMeasurementComponentsRecord value8(BigDecimal value) {
     ...
     */
    @Override
    public ViewMeasurementComponentsRecord values(Integer[] value1, Integer value2, Integer value3, Integer value4, String value5, Integer value6, String value7, BigDecimal value8, ViewMeasurementComponentsMeasurementType value9, Timestamp value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ViewMeasurementComponentsRecord(Integer[] componentIds, Integer measurementId, Integer datasetId, Integer traitId, String traitName, Integer traitUnitId, String traitUnitName, BigDecimal measurement, ViewMeasurementComponentsMeasurementType measurementType, Timestamp createdOn) {
        super(ViewMeasurementComponents.VIEW_MEASUREMENT_COMPONENTS);
